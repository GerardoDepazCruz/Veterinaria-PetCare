...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> login(@RequestBody Map<String, String> loginData) {
        ...
        // Validar que tenga rol Asistente (idRol = 2)
        if (!"Asistente".equalsIgnoreCase(usuario.getRol().getNombre())) {
            response.put("error", "Acceso denegado: no pertenece al rol Asistente");
